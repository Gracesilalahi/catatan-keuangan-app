...
@enderror
                    ...
                    <!-- Category -->
                    <div>
                        <label for="category" class="block text-white font-semibold mb-2">Category</label>
                        <select name="category" id="category"
                                class="w-full bg-white/20 text-white border-white/30 rounded-2xl shadow-sm 
                    ...
                    <!-- Type -->
                    <div>
                        <label for="type" class="block text-white font-semibold mb-2">Type</label>
                    ...
                    <!-- Amount -->
                    <div>
                        <label for="amount" class="block text-white font-semibold mb-2">Amount (Rp)</label>
                    ...
                    @if ($transaction->receipt_image)
                        <div class="mt-4">
                            <label class="block text-white font-semibold mb-2">Current Receipt</label>
                    ...
                    <!-- Upload New Receipt -->
                    <div>
                        <label for="receipt_image" class="block text-white font-semibold mb-2">Upload New Receipt (Optional)</label>
